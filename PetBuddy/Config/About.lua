...
local function CreateAboutCanvas(canvas)
	...
	title:SetText("|cffFFD700PetBuddy|r") -- Gold text color

	-- Description
	local description = canvas:CreateFontString(nil, "ARTWORK", "GameFontHighlight")
	description:SetPoint("TOP", title, "BOTTOM", 0, -10)
	description:SetWidth(500)
	description:SetText("PetBuddy is your ultimate companion management addon, created by Kkthnx. It enhances your gameplay experience by automatically summoning and managing random or favorite non-combat pets during your adventures!")
	...
	motivationHeading:SetText("|cffFFD700Why PetBuddy Exists:|r")
	...
	motivation:SetText("As a passionate player of World of Warcraft, Kkthnx wanted to create an addon that not only celebrates Azeroth's wonderful collection of pets but also simplifies their management. PetBuddy lets you focus on your adventures while your pets join in seamlessly!")
	...
	commands:SetText("/petbuddy or /pb - Open the PetBuddy settings menu.")
	...
	feedbackButton:SetScript("OnClick", function()
		print("Visit the repository for feedback: https://github.com/Kkthnx-Wow/PetBuddy")
	end)
	...
	support:SetText("Have feedback, ideas, or bugs to report? Click 'Report Feedback' or contact us directly. Thank you for using PetBuddy!")
end

-- Register the About canvas with the interface
namespace:RegisterSubSettingsCanvas("About PetBuddy", CreateAboutCanvas)
